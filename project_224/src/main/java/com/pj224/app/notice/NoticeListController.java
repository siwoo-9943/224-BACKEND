...
//       List<NoticeDTO> noticeList = allNoticeList.subList(start, end);
       ...
       result.setRedirect(false); //true
       result.setPath(request.getContextPath() + "/app/notice/notice-admain.jsp");
//       return request.getRequestDispatcher(request.getContextPath() + "/app/notice/notice-admain.jsp").forward(request, response);
       return result;

...
public class CommunityDAO {
	...
	// 수정된 selectAllPaged 메서드
	public List<CommunityDTO> selectAllPaged(int page, int itemsPerPage) {
		try {
	...
	public List<CommunityDTO> selectAllPagedAndFiltered(int page, int itemsPerPage, String category) {
		try {
			...
			List<CommunityDTO> result = sqlSession.selectList("community.selectAllPagedAndFiltered", params);
			sqlSession.commit();
			return result;
		} catch (Exception e) {
			sqlSession.rollback();

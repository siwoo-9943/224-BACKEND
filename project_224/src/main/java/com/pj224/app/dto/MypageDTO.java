...
//      MEMBER_TERMS CHAR(1) NOT NULL
   ...
   public String toString() {
      return "mypageDTO = [memberNumber : " + memberNumber + ",memberEmail : " + memberEmail + ",memberPw : "
            + memberPw + ",memberName : " + memberName + "memberNickname : " + memberNickname + "memberPhone : "
            + memberPhone + "memberPhoneInput : " + memberPhoneInput + "memberGender : " + memberGender
            + "memberBirth : " + memberBirth + "memberTerms : " + memberTerms + "]";
   }

      ...
      <div class="contnets">
        <div class="container">
          <div>
            ...
            <input class="top-inp title" type="text" name="subject" value="고속버스 명당자리.jpg" placeholder="제목을 입력해주세요."
              size="100" maxlength="200">

            <div style="padding: 4px; margin-top: 10px; height: 27px;" class="cheditor-tb-wrapper">

            </div>

            <div class="cheditor-editarea-wrapper">
              <textarea class="cheditor-editarea-text-content" rows="4" cols="50" value="">
              차멀미가 좀 있어서 고속버스 타고 멀리갈때 항상 걱정인데..
				참고하면 좋을 것 같네요!
			  </textarea>
            </div>
            ...
            <div style="display: flex; justify-content: space-between;">
              <div>
                ...
                <button type="button" class="tempas-bt01" id="comu-back-modal"
                  onclick="openBackModal()"><span>취소</span></button>

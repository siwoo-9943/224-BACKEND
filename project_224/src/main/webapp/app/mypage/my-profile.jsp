			...
			<div class="my-profileBox">
				<div class="my-leftbox">
					...
					<div class="my-category">
						...
						<a href="../mypage/my-passcheck.jsp"><div
								class="my-category-menu">개인정보수정</div></a> <a
							href="../mypage/my-comunity.jsp"><div
								class="my-category-menu">내가 작성한 글</div></a> <a
							href="../mypage/my-pick.jsp"><div class="my-category-menu">찜목록</div></a>
						<a href="../mypage/my-quit.jsp"><div class="my-category-menu">회원탈퇴</div></a>
					</div>
				</div>

...
<body>
    <div style="position: relative; height: 350px;">
        ...
        <div style="background-image: url(${pageContext.request.contextPath}/assets/images/conv-seongsu.png); width: 100%; height: 100%;background-size:cover;background-repeat: no-repeat;"></div>
    </div>
                ...
                <div class="hotplace-contents-wrapper">
                    <div class="hotplace-content-left">
                        ...
                        <div class="img-wrapper">
                            <img src="${pageContext.request.contextPath}/assets/images/4.png" style="height: 100%; overflow: hidden; border: 1px solid black;">
                        </div>
                    </div>

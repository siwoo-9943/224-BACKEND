...
var positions = [
    {
        title: '소방서', 
        latlng: new kakao.maps.LatLng(37.55904576874251, 126.92835330963135)
    },
    {
        title: '지구대', 
        latlng: new kakao.maps.LatLng(37.5518276, 126.9134495)
    },
    {
        title: '병원', 
        latlng: new kakao.maps.LatLng(37.55864867534219, 126.92572873034264)
    },
    {
        title: '약국',
        latlng: new kakao.maps.LatLng(37.55873115319592, 126.92583942520488)
    }
];

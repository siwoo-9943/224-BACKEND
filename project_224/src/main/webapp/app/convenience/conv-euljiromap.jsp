...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(37.566070586237714, 126.98267340660095), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
var positions = [
    {
        title: '소방서', 
        latlng: new kakao.maps.LatLng(37.5660286 , 126.9954924)
    },
    {
        title: '지구대', 
        latlng: new kakao.maps.LatLng(37.5630852  , 127.0001521)
    },
    {
        title: '병원', 
        latlng: new kakao.maps.LatLng(37.56620392485378, 126.98405723109154)
    },
    {
        title: '약국',
        latlng: new kakao.maps.LatLng(37.56589093435876, 126.98396891355515)
    }
];

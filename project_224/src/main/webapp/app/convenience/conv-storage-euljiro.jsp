...
<jsp:include page="/header.jsp" />
  ...
  <div class="sub-contents-inner gettingToSeoul" id="container">
    <div class="loction">
      ...
      <span><a href="" title="페이지 이동">을지로입구역</a></span>
    </div>
  </div>
  ...
  <div>
    <div class="conv-storage-contents-wrapper">
      <div class="conv-storage-content-left">
        ...
        <img src="${pageContext.request.contextPath}/assets/images/conv-eulhiro.png" style="height: 256px; width: 256px; margin-bottom: 0px;">
      </div>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(37.566065 , 126.982679), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
var positions = [
    {
        title: '중앙게이트 주변', 
        latlng: new kakao.maps.LatLng(37.56600398600923, 126.9826140680703)
    },
    {
        title: '3번 출입구 방향 통로', 
        latlng: new kakao.maps.LatLng(37.566500133519185, 126.98296642426017)
    },
    {
        title: '4번 출입구 방향 통로', 
        latlng: new kakao.maps.LatLng(37.566333788741716, 126.9832442129295)
    }
];

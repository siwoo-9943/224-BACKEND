  ...
  <div>
    <div class="conv-storage-contents-wrapper">
      <div class="conv-storage-content-left">
        ...
        <img src="${pageContext.request.contextPath}/assets/images/conv-gangnam.png" style="height: 256px; width: 256px; margin-bottom: 0px;">
      </div>
...
var positions = [
    {
        title: '12번 물품보관소', 
        latlng: new kakao.maps.LatLng(37.49843811004795, 127.0285220841894)
    },
    {
        title: '1번 물품보관소', 
        latlng: new kakao.maps.LatLng(37.498037815328075, 127.02871098293457)
    }
];

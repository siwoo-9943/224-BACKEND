...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(37.516637, 126.891505), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
var positions = [
    {
        title: '소방서', 
        latlng: new kakao.maps.LatLng(37.516637 , 126.891505)
    },
    {
        title: '지구대', 
        latlng: new kakao.maps.LatLng(37.51350600000001 , 126.89777)
    },
    {
        title: '병원', 
        latlng: new kakao.maps.LatLng(37.51887702942962, 126.8946267713364)
    },
    {
        title: '약국',
        latlng: new kakao.maps.LatLng(37.51816099934146, 126.89563879012341)
    }
];

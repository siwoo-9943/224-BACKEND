...
<jsp:include page="/header.jsp" />
  <div style="position: relative; height: 350px;">
    <div style="position: absolute; left: 0px; bottom: 0px; right: 0px; z-index: 10;">
      <div style="width: 100%; max-width: 1200px; margin: 0 auto 30px;"><span
          style="font-size: 58px; color: #fff; font-weight: 700;">홍대입구역</span></div>
    </div>
  ...
  <div class="sub-contents-inner gettingToSeoul" id="container">
    <div class="loction">
      ...
      <span><a href="" title="페이지 이동">홍대입구역</a></span>
    </div>
  </div>
  ...
  <div>
    <div class="conv-storage-contents-wrapper">
      <div class="conv-storage-content-left">
        ...
        <img src="${pageContext.request.contextPath}/assets/images/conv-hongdae.png" style="height: 256px; width: 256px; margin-bottom: 0px;">
      </div>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(37.55709106986516, 126.9241317658882), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
var positions = [
    {
        title: '2번 물품보관소', 
        latlng: new kakao.maps.LatLng(37.55714004854157, 126.92386181907646)
    },
    {
        title: '8번 물품보관소', 
        latlng: new kakao.maps.LatLng(37.55688913408449, 126.92413910292055)
    }
];

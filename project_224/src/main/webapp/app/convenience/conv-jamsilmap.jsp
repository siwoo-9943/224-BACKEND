...
var positions = [
    {
        title: '롯데월드', 
        latlng: new kakao.maps.LatLng(37.5111158, 127.098167)
    },
    {
        title: '지구대', 
        latlng: new kakao.maps.LatLng(37.5121063, 127.0821487)
    },
    {
        title: '병원', 
        latlng: new kakao.maps.LatLng(37.51527132970068, 127.10300984359472)
    },
    {
        title: '약국',
        latlng: new kakao.maps.LatLng(37.51456212029688, 127.1066370959243
)
    }
];

  ...
  <div>
    <div class="conv-storage-contents-wrapper">
      <div class="conv-storage-content-left">
        ...
        <img src="${pageContext.request.contextPath}/assets/images/conv-moonrae.png" style="height: 256px; width: 256px; margin-bottom: 0px;">
      </div>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(37.51800199033696, 126.89482033252716), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
...
var positions = [
    {
        title: '2번 물품보관소', 
        latlng: new kakao.maps.LatLng(37.51853097087459, 126.89472493218793)
    }
];
